 ...
 * lead to a {@link FeelingDetailFragment} representing
 * item details. On larger screens, the Navigation controller presents the list of items and
 * item details side-by-side using two vertical panes.
 */

class FeelingListFragment : Fragment() {
    ...
    private var _binding: FragmentFeelingListBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFeelingListBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = binding.feelingList
    ...
    class SimpleItemRecyclerViewAdapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            ...
            val binding = FeelingListContentBinding.inflate(
            ...
            with(holder.itemView) {
                ...
                setOnClickListener { itemView ->
                    ...
                    if (itemDetailFragmentContainer != null) {
                        ...
                        itemView.findNavController().navigate(R.id.show_feeling_detail, bundle)
                    }
                }
        ...
        inner class ViewHolder(binding: FeelingListContentBinding) :
